    ...
    <>
      ...
      <section>
        <article className="introSection" id="home">
          <article className="content">
            <h1 data-aos="fade-down">The browser extension for anyone</h1>
            <p data-aos="fade-up">
              Unleash your creativity with Inscribe, the note-taking extension.{" "}
              <br /> Take your productivity to the next level.
            </p>
      ...
      <article className="features" id="features">
        ...
        <article className="featuresContainer">
          ...
          >
            ...
            <p>
              Effortless capture thoughts on this versatile digital sticky note-
              pops up on your laptop, customizable colours and conveniently
      ...
      <article className="howItWorks" id="how">
        ...
        <article className="content" data-aos="fade-left">
          ...
          <ul>
            ...
            <li>Download the extension and add to your extension shortcut.</li>
            ...
            <li>
              The sticky note can also be expanded to accommodate your needs, it
              is done by clicking the clicking and holding on the bottom right
              corner.
            </li>
          </ul>
          <p>
            You can now browse and take note effortlessly and save your document
            locally. To activate the drawing or scribble feature, you can
            subscribe to our premium plan which is only $2.99 a month!
            <br />
            <br />
      ...
      <article className="helpSection" data-aos="fade-up" id="help">
        <article className="socialLinks">
          ...
          <h2>
            Unleash your creativity with Inscribe. Take your productivity to the
            next level.
          </h2>
        ...
        <article className="contactUs">
          <h3>Contact Us</h3>
          <p>
            For further inquiries reach out to us on our socials or email us at
            inscribeext@gmail{" "}
          </p>
        </article>
      </article>
